                      ...
                      <form action="#">
                        <TableContainer component={Paper}>
                          <Table>
                            <TableHead>
                              <TableRow>
                                <TableCell className="li-product-remove">remove</TableCell>
                                <TableCell className="li-product-thumbnail">images</TableCell>
                                <TableCell className="cart-product-name">Product</TableCell>
                                <TableCell className="li-product-price">Unit Price</TableCell>
                                <TableCell className="li-product-stock-status">Stock Status</TableCell>
                                <TableCell className="li-product-add-cart">add to cart</TableCell>
                              </TableRow>
                            </TableHead>
                            <TableBody>
